    ...
    def run_test(self):
        ...
        for label in labels:
            ...
            for x in range(10):
                ...
                pubkeys.append(node.getaddressinfo(addr)['pubkey'])
            multisig_address = node.addmultisigaddress(5, pubkeys, label.name)['address']
            label.add_address(multisig_address)
            label.purpose[multisig_address] = "receive"
            label.verify(node)
        node.generate(101)
