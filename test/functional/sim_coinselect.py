        ...
        with open(scenario) as f:
            ...
            for line in f:
                ...
                if value < 0:
                    ...
                    self.log.debug("{}: Withdrew {:.8f} with fee {:.8f}, bnb {}, srd {}, balance + fees now {:.8f}".format(ops, value, gettx['fee'], csinfo['BnB_Usage'], csinfo['SRD_Usage'],self.nodes[1].getbalance() - total_fees))
