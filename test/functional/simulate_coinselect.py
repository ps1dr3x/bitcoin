    ...
    def run_test(self):
        ...
        for FEES_FILE in files:
            ...
            for i, FILENAME in enumerate(files, start=1):
                ...
                # Print stuff
                self.log.info("| final value | mean #UTXO | final #UTXO | #received | #spent | #payments sent |"
                ...
                self.log.info(" | " + str(self.nodes[i].getbalance()) + " | " + str(Decimal(mean(utxo_set_sizes))) + " | " + str(len(remaining_utxos)) + " | " + str(count_received) + " | " + str(count_sent) + " | " + str(payments) + " | " 
