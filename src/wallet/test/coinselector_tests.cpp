...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
    ...
    BOOST_CHECK(!testWallet.SelectCoinsMinConf( 1 * CENT, filter_standard, vCoins, setCoinsRet, nValueRet, coin_selection_params, bnb_used, true, true));
}
...
BOOST_AUTO_TEST_CASE(SelectCoins_test)
{
    ...
    for (int i = 0; i < 100; ++i)
    {
        ...
        CAmount out_value = 0;
        bool bnb_used = false;
        BOOST_CHECK(testWallet.SelectCoinsMinConf(target, filter_standard, vCoins, out_set, out_value, coin_selection_params, bnb_used, true, true) ||
                    testWallet.SelectCoinsMinConf(target, filter_standard, vCoins, out_set, out_value, coin_selection_params, bnb_used, true, true));
