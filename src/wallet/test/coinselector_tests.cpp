...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
    ...
    BOOST_CHECK(!testWallet.SelectCoinsMinConf( 1 * CENT, filter_standard, vCoins, setCoinsRet, nValueRet, coin_selection_params, true, true));
}
...
BOOST_AUTO_TEST_CASE(SelectCoins_test)
{
    ...
    for (int i = 0; i < 100; ++i)
    {
        ...
        CoinSet out_set;
        CAmount out_value = 0;
        BOOST_CHECK(testWallet.SelectCoinsMinConf(target, filter_standard, vCoins, out_set, out_value, coin_selection_params, true, true) ||
                    testWallet.SelectCoinsMinConf(target, filter_standard, vCoins, out_set, out_value, coin_selection_params, true, true));
