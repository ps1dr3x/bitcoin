...
extern UniValue walletupdatepsbt(const JSONRPCRequest& request);

BOOST_FIXTURE_TEST_SUITE(psbt_creator_tests, WalletTestingSetup)
...
BOOST_AUTO_TEST_CASE(psbt_updater_test)
{
    ...
    fill_psbt(&m_wallet, psbtx, &txConst, 1, false);
